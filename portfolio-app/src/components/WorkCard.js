...
const WorkCard = () => {
  return (
    <div className="flex flex-col items-center md:flex md:flex-row md:justify-center md:mb-12 mb-6 even:flex-row-reverse">
      ...
      <div className="dark:bg-[#1F2937] p-8 md:p-8 w-[343px] md:h-[480px] md:w-[576px] shadow-lg rounded-r-lg">
